          ...
          <div className="px-6 max-w-screen-xl mx-auto">
            ...
            <div className="flex m-5">
              <button
                ...
                className="p-2 bg-green-500 text-white rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-red-400"
              >
                <IoIosAddCircle />
              </button>
                ...
                <div className="bg-white p-4 rounded-md">
                  ...
                  <div className="flex justify-center mt-4">
                    ...
                    <button
                      ...
                      className="justify-center px-4 py-2 mr-2 bg-gray-500 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                    >
                      GO BACK
                    </button>
                  </div>
